 ...
 *
 * Reused by both the Inventory intake screen (look up a product to
 * add stock) and the POS screen (Batch 3) — this is exactly the kind
 * of shared, stateless interaction logic worth its own component
 * rather than duplicating in both places.
 */
"use client";
